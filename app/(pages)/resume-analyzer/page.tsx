// app/(main)/resume-analyzer/page.tsx
"use client";
...
import { Share, FileText, Sparkles, BookText } from "lucide-react";
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="flex items-center justify-between p-4 border-b dark:border-zinc-800 border-zinc-200">
          <div className="flex items-center gap-3">
            <h2 className="text-lg font-medium capitalize">Resume Analyzer</h2>
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            {/* Tips Section - Fixed positioning */}
